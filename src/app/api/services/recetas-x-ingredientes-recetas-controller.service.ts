...
export class RecetasXIngredientesRecetasControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation recetasXIngredientesRecetasControllerGetRecetas
   */
  static readonly RecetasXIngredientesRecetasControllerGetRecetasPath = '/recetas-x-ingredientes/{id}/recetas';
  ...
  getRecetas$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RecetasXIngredientesRecetasControllerService.RecetasXIngredientesRecetasControllerGetRecetasPath, 'get');
    if (params) {
